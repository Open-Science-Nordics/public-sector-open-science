...
- Domestic Example: [Recent Swedish ClimateGate - SMHI / Swedish Meteorological and Hydrological Institute Propaganda Allegations](http://www.svd.se/sd-till-attack-mot-smhi-propaganda)
- International Example: Is increased economic growth linked to higer emissions levels of carbon dioxide and other greenhouse gases? The [Obama Paper](http://science.sciencemag.org/content/early/2017/01/06/science.aam6284.full) - political propaganda or reproducible scientific facts?
...
## Web UIs Web Data using R

Web-based User Interfaces and Web-services for Data with R:
